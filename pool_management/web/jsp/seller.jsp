...
<body>
    <header>
        ...
        <div class="header-links">
            <a href="${pageContext.request.contextPath}/EmployeeDashboard">Quay lại Employee Dashboard</a>
            <a href="${pageContext.request.contextPath}/Seller?action=viewCart" class="cart-icon">🛒
