CREATE DATABASE SwimmingPoolManagement;
GO

USE SwimmingPoolManagement;
GO
...
-- 12. Employee (UserID là khóa chính ??ng th?i là khóa ngo?i => không dùng IDENTITY)
...
-- 2. Insert into SwimmingPools
INSERT INTO SwimmingPools (Name, Location, Description, Status) VALUES 
('Sunset Pool', '123 Main St, Hanoi', 'Olympic-sized pool with modern facilities', 1),
('Blue Wave Pool', '456 Tran Phu, Ho Chi Minh City', 'Family-friendly pool with slides', 1),
('Starlight Pool', '789 Nguyen Trai, Da Nang', 'Indoor pool with heating system', 0),
('Moonlight Pool', '101 Le Van Sy, Ho Chi Minh City', 'Outdoor pool with night lighting', 1),
('Crystal Lake Pool', '222 Ba Dinh, Hanoi', 'Large pool for competitive swimming', 1),
('Ocean Breeze Pool', '333 Hai Phong, Da Nang', 'Pool with ocean view', 0),
('Golden Sun Pool', '555 Hoang Hoa Tham, Hanoi', 'Luxury pool with spa facilities', 1),
('Aqua Park Pool', '666 Nguyen Van Cu, Ho Chi Minh City', 'Pool with water parkfeatures', 1),
('Silver Wave Pool', '777 Ly Thuong Kiet, Da Nang', 'Training pool for athletes', 1),
('Emerald Pool', '888 Le Lai, Ho Chi Minh City', 'Eco-friendly pool with solar heating', 1),
('Skyline Pool', '999 Hoang Dieu, Hanoi', 'Rooftop pool with city views', 1),
('Coral Reef Pool', '111 Ba Huyen Thanh Quan, Da Nang', 'Themed pool for relaxation', 0),
('Pearl Pool', '222 Nguyen Thi Minh Khai, Ho Chi Minh City', 'Luxury indoor pool with jacuzzi', 1),
('Riverfront Pool', '333 Hang Bong, Hanoi', 'Outdoor pool with scenic views', 1),
('Tropical Oasis Pool', '444 Tran Hung Dao, Da Nang', 'Tropical-themed pool for families', 0);
...
-- 10. Insert into TrainerBookings
INSERT INTO TrainerBookings (UserID, PoolID, BookingDate, UserName, Note) VALUES 
(4, 1, '2025-05-25', N'Lê Thị Duyên', 'Beginner swim lesson'),
(4, 2, '2025-05-26', N'Lê Thị Duyên', 'Advanced freestyle training'),
(4, 3, '2025-05-27', N'Lê Thị Duyên', 'Group lesson'),
(9, 4, '2025-05-28', N'Ngô Thị Mai', 'Private swim lesson'),
(9, 5, '2025-05-29', N'Ngô Thị Mai', 'Group training session'),
(9, 6, '2025-05-30', N'Ngô Thị Mai', 'Beginner coaching'),
(13, 7, '2025-05-31', N'Võ Thị Lan', 'Intermediate swim lesson'),
(13, 8, '2025-06-01', N'Võ Thị Lan', 'Group freestyle training'),
(13, 9, '2025-06-02', N'Võ Thị Lan', 'Private lesson'),
(17,10, '2025-06-03', N'Hà Thị Quyên', 'Beginner swim lesson'),
(17,11, '2025-06-04', N'Hà Thị Quyên', 'Advanced stroke training'),
(17,12, '2025-06-05', N'Hà Thị Quyên', 'Group lesson'),
(19, 13, '2025-06-06', N'Phạm Văn Đạt', 'Beginner swim lesson'),
(19, 14, '2025-06-07', N'Phạm Văn Đạt', 'Group training session'),
(18, 15, '2025-06-08', N'Nguyễn Văn Bảo', 'Private lesson');

-- 11. Insert into UserReviews
...
-- 13. Insert into WarehouseManagers
...
-- XÓA DỮ LIỆU (theo thứ tự ràng buộc khóa ngoại)
DELETE FROM Notifications;
DELETE FROM WarehouseManagers;
DELETE FROM Employee;
DELETE FROM UserReviews;
DELETE FROM TrainerBookings;
DELETE FROM [Order];
...
DELETE FROM Product;
DELETE FROM Users;
DELETE FROM SwimmingPools;
DELETE FROM Roles;

-- xóa hết bảng (phải tạo lại bảng nếu xóa dữ liệu xong bị lỗi insert)
...
DROP TABLE IF EXISTS SwimHistory;
