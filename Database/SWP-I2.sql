	...
	-- Create the database
	CREATE DATABASE SwimmingPoolManagement6;
	GO

	-- Use the newly created database
	USE SwimmingPoolManagement6;
	GO
...
GO
	...
	Price            DECIMAL(10, 2) NOT NULL,  -- Giá lớp học
	Description      NVARCHAR(255)
);
	go
	/* =============================
	...
	(3, N'Nguyễn Văn Ba', 'an.nguyen@example.com', '123456', '0901234567', N'12 Trần Hưng Đạo, Q1, TP.HCM', 'images/avatar1.png', '2024-01-01 08:00:00'),
	...
	INSERT INTO Product (PoolID, ProductName, Description, Price, AddedDate, Quantity, Image, Status, CategoryID, IsRentable, RentalPrice)
VALUES
(1, N'Kính bơi', N'Kính bơi chống mờ', 120000, '2025-06-01', 100, 'goggles.jpg', 1, 2, 1, 40000),
(1, N'Mũ bơi', N'Mũ bơi silicone', 60000, '2025-06-02', 200, 'cap.jpg', 1, 2, 1, 20000),
(1, N'Chân vịt bơi', N'Chân vịt dùng để luyện tập', 220000, '2025-06-03', 50, 'fins.jpg', 1, 2, 1, 70000),
(1, N'Khăn bơi', N'Khăn sợi microfiber mau khô', 80000, '2025-06-04', 150, 'towel.jpg', 1, 2, 1, 25000),
(1, N'Túi bơi', N'Túi đựng đồ bơi chống nước', 150000, '2025-06-05', 80, 'bag.jpg', 1, 2, 1, 50000),
(1, N'Ván đập chân', N'Ván xốp hỗ trợ tập luyện bơi', 160000, '2025-06-06', 60, 'kickboard.jpg', 1, 2, 1, 60000),
(1, N'Nút tai bơi', N'Nút tai silicone chống nước', 40000, '2025-06-07', 200, 'earplugs.jpg', 1, 2, 1, 15000),
(1, N'Thanh năng lượng', N'Thanh ăn nhẹ giàu protein', 25000, '2025-06-16', 100, 'proteinbar.jpg', 1, 1, 0, 0),
(1, N'Nước tăng lực', N'Bù nước và tăng năng lượng', 20000, '2025-06-16', 150, 'energydrink.jpg', 1, 1, 0, 0),
(1, N'Ly trái cây', N'Trái cây tươi trộn sẵn', 25000, '2025-06-16', 80, 'fruitcup.jpg', 1, 1, 0, 0),
(1, N'Nước đóng chai', N'Nước khoáng 500ml', 10000, '2025-06-16', 300, 'water.jpg', 1, 1, 0, 0),
(1, N'Sinh tố', N'Sinh tố chuối và dâu tây', 30000, '2025-06-16', 60, 'smoothie.jpg', 1, 1, 0, 0),
(1, N'Bánh mì kẹp', N'Bánh mì kẹp thịt gà và rau', 35000, '2025-06-16', 70, 'sandwich.jpg', 1, 1, 0, 0),
(1, N'Sữa chua', N'Sữa chua Hy Lạp kèm mật ong', 15000, '2025-06-16', 90, 'yogurt.jpg', 1, 1, 0, 0),
(1, N'Thanh granola', N'Thanh ngũ cốc và hạt dinh dưỡng', 20000, '2025-06-16', 110, 'granola.jpg', 1, 1, 0, 0),
(1, N'Trà đá', N'Trà chanh pha lạnh', 15000, '2025-06-16', 130, 'icedtea.jpg', 1, 1, 0, 0),
(1, N'Sữa socola', N'Sữa socola ít béo', 20000, '2025-06-16', 100, 'chocolatemilk.jpg', 1, 1, 0, 0);
GO


INSERT INTO ProductRental (ProductID, PoolID, StartDate, EndDate, RentalPrice, TotalCost, Status, CustomerName, PhoneNumber)
VALUES 
(1, 1, '2025-06-24 09:00:00', '2025-06-24 12:00:00', 50000, 150000, N'Active', N'Trần Thị Ánh', N'0901234567'),
(2, 1, '2025-06-23 10:00:00', '2025-06-23 13:00:00', 30000, 90000, N'Completed', N'Hoàng Văn Em', N'0912345678');
GO
    ...
    (TrainerID, PoolID, ClassName, ClassDate,
     StartTime, EndTime, MaxParticipants, Price, Description)
VALUES
-- ---- Trainer 4 ----
(4, 1,  N'Beginner Crawl Basics',      '2025-07-05', '08:00', '09:30', 10, 200000, N'Fundamentals of front-crawl for new swimmers'),
(4, 1,  N'Backstroke Fundamentals',    '2025-07-12', '10:00', '11:30', 10, 220000, N'Entry-level backstroke drills and kicks'),
(4, 2,  N'Adult Technique Refinement', '2025-07-19', '08:00', '09:30', 12, 250000, N'Stroke correction for adult learners'),
(4, 2,  N'Turns & Push-Off Workshop',  '2025-07-26', '10:00', '11:30', 12, 240000, N'Flip-turns and efficient wall push-offs'),

-- ---- Trainer 9 ----
(9, 3,  N'Freestyle Endurance',        '2025-07-07', '15:00', '16:30', 15, 230000, N'Build stamina with long-set freestyle training'),
(9, 3,  N'Dolphin Kick Clinic',        '2025-07-14', '15:00', '16:30', 12, 220000, N'Improve underwater dolphin kicks for speed'),
(9, 4,  N'Race-Starts Mastery',        '2025-07-21', '17:00', '18:30', 12, 250000, N'Block starts, dives, and breakout drills'),

-- ---- Trainer 13 ----
(13, 5, N'Kids Splash & Learn',        '2025-07-09', '09:00', '10:00', 15, 180000, N'Play-based water confidence for ages 6-10'),
(13, 5, N'Butterfly Made Easy',        '2025-07-16', '09:00', '10:00', 10, 200000, N'Progressive butterfly drills for intermediates'),
(13, 6, N'IM Challenge Prep',          '2025-07-23', '11:00', '12:30', 12, 260000, N'Train for Individual Medley events'),

-- ---- Trainer 17 ----
(17, 4, N'Junior Competitive Squad',   '2025-07-10', '16:00', '17:30', 12, 270000, N'High-intensity sets for junior racers'),
(17, 4, N'Tumble-Turn Intensive',      '2025-07-17', '16:00', '17:30', 10, 250000, N'Special focus on fast flip-turns'),
(17, 7, N'Open-Water Simulation',      '2025-07-24', '07:00', '08:30', 15, 280000, N'Pack-swim tactics and sighting practice'),

-- ---- Trainer 20 ----
(20, 8, N'Lifeguard Skills Refresher', '2025-07-06', '13:00', '15:00', 12, 300000, N'Rescue techniques and first-aid drills'),
(20, 8, N'Night Swim Conditioning',    '2025-07-13', '19:00', '20:30', 10, 230000, N'After-hours endurance and pacing session');

	/* 15 booking – mỗi lớp 1 học viên */
	INSERT INTO TrainerBookings(UserID, PoolID, TrainerID, ClassID, BookingDate, StartTime, EndTime,BookPrice, Status, RegisterName, Note)
	VALUES
